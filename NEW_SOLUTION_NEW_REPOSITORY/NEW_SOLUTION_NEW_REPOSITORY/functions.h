...
void add(Tree<int, WorldCup>&, Tree<double, WorldCup>&, Tree<int, WorldCup>&, Tree<int, WorldCup>&, Tree<int, WorldCup>&, Tree<int, TeamsParticipated>&, HashTable<int, WorldCup>&, HashTable<int, FinalMatch>&, HashTable<int, TeamsParticipated>&);
