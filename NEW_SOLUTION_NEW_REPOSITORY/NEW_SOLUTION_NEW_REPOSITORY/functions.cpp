...
void initializeWorldCupData(WorldCup *worldC, Tree<std::string, WorldCup> namesT, Tree<double, WorldCup> gpgT, Tree<int, WorldCup>aveAttT, Tree<int, WorldCup> totalAtt)
{
	int index = 0;
